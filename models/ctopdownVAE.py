...
class ConditionalTopDownVAE(nn.Module):
    def __init__(self, x_dim, y_dim, h1_dim=64, h2_dim=64, e_dim=64, ze_dim=64, z1_dim=64, z2_dim=64, r1_dim=64, hid_dim=64, n_layers=3, activation='relu'):
        ...
        self.cmlp_z2_r1= CMLP(z2_dim, r1_dim, ze_dim, hid_dim=hid_dim, n_layers=n_layers, activation=activation, last_activation=None)
        # self.cmlp_z2_z1= CMLP(z2_dim, 2 * z1_dim, ze_dim, hid_dim=hid_dim, n_layers=n_layers, activation=activation, last_activation=None)
        self.cmlp_r1_z1= CMLP(r1_dim, 2 * z1_dim, ze_dim, hid_dim=hid_dim, n_layers=n_layers, activation=activation, last_activation=None)
        self.pn_h1_z1 = PointNet(h1_dim, 2 * z1_dim, hid_dim=hid_dim, n_layers=n_layers, activation=activation, last_activation=None)
        self.cmlp_z1_x= CMLP(z1_dim + r1_dim, 2 * x_dim, ze_dim, hid_dim=hid_dim, n_layers=n_layers, activation=activation, last_activation=None)
